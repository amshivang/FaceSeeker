...
5. **High-Res Inspection**: Confirmed match frames are captured in 1080p, rendered in the side-by-side inspector and seekbar.
...
pip install opencv-python numpy flask pywebview werkzeug pyinstaller
